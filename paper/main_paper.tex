...
The official code repository accompanies this submission at \url{https://anonymous.4open.science/r/cova-tad-964D} (and provided via the supplementary code archive), containing the complete CoVA-TAD estimator, data loader, benchmark runner, Isolation Forest control, and reproducible figure and table generation scripts.
...
\midrule
\input{appendix_results_rows.tex}%
\end{tabular}
\end{table*}
...
\midrule
\input{appendix_all_baselines_1.tex}%
\end{tabular}
\end{table}
...
\midrule
\input{appendix_all_baselines_2.tex}%
\end{tabular}
\end{table}
...
The complete code, configuration files, and benchmark runners are hosted at \url{https://anonymous.4open.science/r/cova-tad-964D}. From a clean Python 3.10--3.12 environment, the following commands reproduce the result CSV, statistics, tables, and figures:
\begin{verbatim}
